...
#define LOW_PRECISION`),e}function Sw(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===a0?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===ay?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ms&&(e="SHADOWMAP_TYPE_VSM"),e}function bw(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case No:case Uo:e="ENVMAP_TYPE_CUBE";break;case hh:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Tw(s){let e="ENVMAP_MODE_REFLECTION";return s.envMap&&s.envMapMode===Uo&&(e="ENVMAP_MODE_REFRACTION"),e}function ww(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case l0:e="ENVMAP_BLENDING_MULTIPLY";break;case Ey:e="ENVMAP_BLENDING_MIX";break;case Ay:e="ENVMAP_BLENDING_ADD";break}return e}function Ew(s){let e=s.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Aw(s,e,t,n){let i=s.getContext(),r=t.defines,o=t.vertexShader,a=t.fragmentShader,l=Sw(t),c=bw(t),h=Tw(t),u=ww(t),f=Ew(t),d=pw(t),g=mw(r),_=i.createProgram(),m,p,y=t.glslVersion?"#version "+t.glslVersion+`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};jo.BlurDirectionX=new Ue(1,0);jo.BlurDirectionY=new Ue(0,1);var F0={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
